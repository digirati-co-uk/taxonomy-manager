...
public class SkosPersistenceException extends Exception {
	...
	public static SkosPersistenceException relationshipAlreadyExists(ConceptSemanticRelationModel relationship) {
	...
	public static SkosPersistenceException relationshipNotFound(String sourceId, String targetId) {
		return new SkosPersistenceException("Relationship between " + sourceId + " and " + targetId + " was not found");
	}

	public static SkosPersistenceException relationshipNotFound(String sourceId, String targetId, Throwable t) {
		return new SkosPersistenceException("Relationship between " + sourceId + " and " + targetId + " was not found", t);
	}

	public static SkosPersistenceException relationshipNotFound(ConceptSemanticRelationModel relationship) {
	...
	public static SkosPersistenceException unableToCreateRelationship(ConceptSemanticRelationModel relationship) {
		return new SkosPersistenceException("Unable to create relationship: " + relationship);
	}

	public static SkosPersistenceException unableToCreateRelationship(ConceptSemanticRelationModel relationship, Throwable t) {
	...
	public static SkosPersistenceException unableToUpdateConceptScheme(String id) {
		return new SkosPersistenceException("Unable to update concept scheme with ID=" + id);
	}

	public static SkosPersistenceException unableToUpdateRelationship(ConceptSemanticRelationModel relationship) {
		return new SkosPersistenceException("Unable to update relationship: " + relationship);
	}

	public static SkosPersistenceException unableToUpdateRelationship(ConceptSemanticRelationModel relationship, Throwable t) {
